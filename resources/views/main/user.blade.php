...
@section('main_content')
                        ...
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="box border-3" style="text-align: center; line-height: 2.0; height: 360px;">
                                    ...
                                    <div class="col-span-12 sm:col-span-6 xl:col-span-6 intro-y mt-6 mb-2 ml-10">
                                        <form id="add_user_form" class="my-auto mx-auto bg-white xl:bg-transparent sm:px-8 xl:p-0 rounded-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto" action="" method="post">
                                            <input type="text" id="add_u_uname_id" name="u_uname" class="p-2 border-theme-123 border-2 block mb-2" style="width: 87%; height:30px; font-size:85%;" placeholder="Allocate a Username">
                        ...
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="box border-3" style=" line-height: 2.0; height: 488px;">
                                    ...
                                    <form id="search_form" class="my-auto mx-auto bg-white xl:bg-transparent sm:px-8 xl:p-0 rounded-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto" action="" method="get">
                                        ...
                                        <input type="text" name="search" id="search_id" class="p-2 border-theme-123 border-2 block m-2" style="height:35px; width: 81%; font-size:85%; display:inline" placeholder="Search User...">
                                        <div class="" style="">
    ...
    <div class="modal" id="edit_user_modal" style="">
        <div class="modal__content">
            <div class="px-5 pb-0"><br>
                <div style="font-size:25px">Edit User</div>
            </div>
                ...
                <div class="intro-y col-span-12 lg:col-span-8 p-5">
                    <div class="grid grid-cols-12 gap-4 row-gap-5">
                        <div class="intro-y col-span-12 px-2">
                            ...
                            <input type="text" name="u_uname" id="edit_u_uname_id" class="input w-full border flex-1">
                        </div>
                        <div class="intro-y col-span-12 px-2">
                            <div class="mb-2">Email</div>
                            <input type="email" name="u_email" id="edit_u_email_id" class="input w-full border flex-1">
                        </div>
                        <div class="intro-y col-span-12 px-2">
                            <div class="mb-2">Password</div>
                            <input type="text" name="u_pass" id="edit_u_pass_id" class="input w-full border flex-1">
                        </div>
                        <div class="intro-y col-span-12 px-2">
                            <div class="mb-2">Full Name</div>
                            <input type="text" name="u_name" id="edit_u_name_id" class="input w-full border flex-1">
                        </div>
                        <div class="intro-y col-span-12 px-2">
...
<script>
    ...
    $(document).ready(function(){
                    ...
                    for (let i = 0; i < data.data.length; i++) {
                        $("#check2").append(`
                            <div  class="flex border-2 border-theme-123 m-2 btn_zoo_g " style="height: 30px;font-size:0.9rem; ">
                                <button value="`+data.data[i].id+`" class="ml-2 mr-auto update_user" id="special_id" style="display:inline;  text-decoration:underline;">`+data.data[i].u_name+`</button>
        ...
        function new_fun_2(id2){
            ...
            $.ajax({
                type:"GET",
                url:'users/search?search='+glb_vbl+'&page='+id2+'',
            }).done(function(data){
        ...
        $(document).on("click",".update_user",function(e){
            ...
            // console.log(data);
            $("#edit_u_uname_id").val(data.u_uname);
