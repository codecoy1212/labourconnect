                ...
                <div class="grid grid-cols-12 gap-6 mt-0 xl:ml-12 xl:mr-12" style="font-weight: bold">
                    <div class="col-span-12 sm:col-span-6 xl:col-span-6 intro-y mt-8 mb-2">
                        ...
                        <form id="search_form" class="my-auto mx-auto bg-white xl:bg-transparent sm:px-8 xl:p-0 rounded-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto" action="" method="get">
                            ...
                            <div id="check2"></div>
                            <div id="check"></div>
                                <select id="add_user_role_id" name="role_id" form="new_job_form" class="select_role intro-x input--lg border-theme-123 border-2 block mb-2" style="width: 90%; font-size:85%; height:33px; background-color:white;" disabled>
    ...
    $(document).ready(function(){
        ...
        $(document).on("submit","#prices_form", function(event){
            ...
            $.ajax({
                ...
                data: { j_location: id2, company_id: id1, j_date: id3, job_users: glb_arr, users_role: glb_arr_2, roles_prices: glb_arr_3, p_start: id4, p_end: id5},
